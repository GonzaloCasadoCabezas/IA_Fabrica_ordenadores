...
def cooling_system(env, name, mf, assembly_time, main_assembly_time, components_store, transport_time):
    """
    Simulates the manufacturing and transportation of a cooling system.
    :param env: Simulation environment.
    :param name: Name of the cooling system.
    ...
    with mf.request() as req:
        ...
        # Send component to store
        yield components_store.put('CoolingSystem')
        print(f'{name}: Cooling system sent to component store at time {round(env.now, 2)}')
